...
?>
<!doctype html><html lang="th"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title><?=h($title)?></title><link rel="stylesheet" href="assets/sales-table.css"></head><body><main>
<header><small><?=h((string)(branch_current($d)['name']??''))?></small><h1><?=h($title)?></h1><nav><a href="pos-drinks.php">1. ค่าดื่ม</a> · <a href="pos-commission.php">2. ค่าคอม</a> · <a href="admin.php">กลับหลังบ้าน</a></nav>
<p><?=$posCore==='drinks'?'จำนวนดื่มส่วนตัวของ PR / Sales × อัตราค่าดื่ม':'ค่าคอมจากดื่ม PR ในทีมที่ Sales ดูแล'?></p></header>
