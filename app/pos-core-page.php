...
<header><small><?=h((string)(branch_current($d)['name']??''))?></small><h1><?=h($title)?></h1><nav><a href="pos-drinks.php">1. ค่าดื่ม</a> · <a href="pos-commission.php">2. ค่าคอม</a> · <a href="pos-reports.php">Report</a> · <a href="admin.php">กลับหลังบ้าน</a></nav>
